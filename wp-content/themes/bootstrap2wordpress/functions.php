...
if ( ! function_exists( 'bootstrap2wordpress_setup' ) ) :
	...
	function bootstrap2wordpress_setup() {
		...
		// 	'menu_1' => esc_html__( 'Primary', 'bootstrap2wordpress' ),
		// ) );
		register_nav_menus( array(
...
function new_excerpt_more($more) {
	global $post;
	return '...<br><a class="moretag" href="'. get_permalink($post->ID) . '"> continue reading &raquo;</a>';
}
add_filter('excerpt_more', 'new_excerpt_more');

/**
 * Limits the excerpt word count
 */
